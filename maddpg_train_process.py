	...
	for ep in range(int(args['max_episodes'])):
		...
		if ep%100==0:
			for k in range(env.n):
				...
				file5 = './results/savedmodels/actor'+str(k)+'/main'+str(ep)+ 'full' +'.h5'
				file6 = './results/savedmodels/actor'+str(k)+'/target'+str(ep)+ 'full'+'.h5'
				file7 = './results/savedmodels/critic'+str(k)+'/main'+str(ep)+ 'full'+'.h5'
				file8 = './results/savedmodels/critic'+str(k)+'/target'+str(ep)+ 'full'+'.h5'
				# actor = actors[k]
				# critic = critics[k]
